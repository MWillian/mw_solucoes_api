...
namespace MwSolucoes.Application.Interfaces
{
    public interface IMaintenanceService
    {
        ...
        Task<ResponseGetMaintenanceService> GetMaintenanceServiceById(int id);
        Task<PagedResult<ResponseGetMaintenanceService>> GetMaintenanceServices(MaintenanceServiceFilters filters);
